            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="row text-center">
                        ...
                        <div class="col">
                            <a class="btn btn-danger btn-sm" href="{{ route('staff.data_pendatang.destroy', $dt->id) }}" onclick="event.preventDefault(); document.getElementById('delete-form{{ $dt->id }}').submit();">
                                <i class="fas fa-trash"></i>
                            </a>
                            <form id="delete-form{{ $dt->id }}" action="{{ route('staff.data_pendatang.destroy', $dt->id) }}" method="POST" style="display: none;">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <form action="{{ route('staff.data_pendatang.update', $dt->id) }}" method="POST">
                                    @method('PUT')
                                    @csrf
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('staff.data_pendatang.store') }}" method="POST">
                    @csrf
