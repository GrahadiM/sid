...
@section('content')
    ...
    {!! Form::model($announcement, ['method' => 'PATCH', 'route' => ['admin.announcement.update', $announcement->id]]) !!}
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Edit Data</h3>
            <div class="card-tools">
                <a href="{{ route('admin.dashboard') }}" class="btn btn-danger btn-sm">Kembali</a>
            </div>
        </div>
        <div class="card-body">
